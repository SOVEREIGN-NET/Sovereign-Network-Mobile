...
This module provides economic logic for ZHTP protocols, integrating with the `lib-economy` package for DAO fees, UBS, and economic models.

## Main Types
- `ZhtpEconomics`: Holds the economic model and config.
- `EconomicConfig`: Configures DAO fees, UBS, and fee calculation methods.
