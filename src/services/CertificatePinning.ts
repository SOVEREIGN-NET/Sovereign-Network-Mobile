...
// Build certificate pins from .env.generated.json
// Certificate pin is generated by scripts/generate-config.js from .env file
export const PINNED_CERTIFICATES: Record<string, CertificatePin> = generatedConfig.CERTIFICATE_PIN
  ? {
      [generatedConfig.ZHTP_NODE_HOST]: {
        host: generatedConfig.ZHTP_NODE_HOST,
        sha256Pin: generatedConfig.CERTIFICATE_PIN,
      },
    }
  : {};
