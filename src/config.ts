...
export const DEFAULT_SOV_NODE_URL = generatedConfig.ZHTP_NODE_URL || 'http://77.42.37.161:9334';

/**
 * Default node host and port (pre-parsed from URL by build script)
 * These are generated by scripts/generate-config.js at build time
 */
export const DEFAULT_NODE_HOST = generatedConfig.ZHTP_NODE_HOST || '77.42.37.161';
export const DEFAULT_NODE_PORT = parseInt(
  String(generatedConfig.ZHTP_NODE_PORT || 9334),
  10
);
